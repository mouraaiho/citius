          ...
          <div id="home-tab" class="tab-pane active">                                         
           ...
           <div  data-rel="scroll" data-scrollheight="550">
               <ul class="list-wrapper pd-lr-15">
                    <li>  
                        <div class="menu-icon"><a href="#"><img alt="example image" src="asset('img/avatar/avatar.jpg')"></a></div> 
                        <div class="menu-text"> 
          ...
          <div id="list-tab" class="tab-pane">
               ...
               <div data-rel="scroll" >
                   <ul class="list-wrapper">
                    <li> <a href="#"> 
                    		<div class="menu-icon width-50"><img alt="example image" src="asset('img/avatar/avatar.jpg')"></div> 
                         </a>
                    ...
                    <li> 
                    		<a href="#"> 
                    			<div class="menu-icon width-50"><img alt="example image" src="asset('img/avatar/avatar-2.jpg')"></div>  
                            </a>                            
                    ...
                    <li> <a href="#"> 
                    		<div class="menu-icon width-50"><img alt="example image" src="asset('img/avatar/avatar-3.jpg')"></div> 
                         </a>    
                    ...
                    <li> <a href="#"> 
                    		<div class="menu-icon width-50"><img alt="example image" src="asset('img/avatar/avatar-4.jpg')"></div> 
                         </a>    
                    ...
                    <li> <a href="#"> 
                    		<div class="menu-icon width-50"><img alt="example image" src="asset('img/avatar/avatar-5.jpg')"></div>  
                         </a>   
                    ...
                    <li> <a href="#"> 
                    		<div class="menu-icon width-50"><img alt="example image" src="asset('img/avatar/avatar-6.jpg')"></div>
                         </a>    
                    ...
                    <li> <a href="#"> 
                    		<div class="menu-icon width-50"><img alt="example image" src="asset('img/avatar/avatar-7.jpg')"></div> 
                         </a>   
                    ...
                    <li> <a href="#"> 
                    		<div class="menu-icon width-50"><img alt="example image" src="asset('img/avatar/avatar-8.jpg')"></div>
                         </a>    
